...
declare -A GIT_CRATES=(
	[anime-game-core]='https://github.com/an-anime-team/anime-game-core;a06068a2161b1d7b7969e2306aa08404406d78fa;anime-game-core-%commit%'
	[anime-launcher-sdk]='https://github.com/an-anime-team/anime-launcher-sdk;c1253c7b72115ec0c0b164c5e0137f333362e53f;anime-launcher-sdk-%commit%'
)
...
DESCRIPTION="An anime borb launcher for Linux with automatic anti-cheat patching"
HOMEPAGE="https://github.com/an-anime-team/an-anime-borb-launcher"
SRC_URI="
	https://github.com/an-anime-team/an-anime-borb-launcher/archive/${PV}.tar.gz -> ${P}.tar.gz
	$(cargo_crate_uris)
"
...
src_prepare() {
	...
	sed -i 's/Icon=icon/Icon=moe.launcher.anime-borb-launcher/' assets/anime-borb-launcher.desktop || die
	sed -i 's/Exec=AppRun/Exec=anime-borb-launcher/' assets/anime-borb-launcher.desktop || die
...
src_install() {
	cargo_src_install
	domenu assets/anime-borb-launcher.desktop
	newicon assets/images/icon.png moe.launcher.anime-borb-launcher.png
}
